...
export interface WorkspaceContext {state:AppState;user:User;command:(type:string,payload:unknown)=>Promise<AppState>;refresh:()=>Promise<void>;notify:(message:string)=>void;busy:boolean}
